...
train_img_list = glob.glob("C:/Users/Prajjwal/Desktop/data/train/*.png")
test_img_list = glob.glob("C:/Users/Prajjwal/Desktop/data/test/*.png")
...
model.add(Flatten())#converts a 2d matrix into a one dimensional matrix that can be fed into a fully connected neural network.
